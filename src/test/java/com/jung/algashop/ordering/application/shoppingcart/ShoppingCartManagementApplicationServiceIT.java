package com.jung.algashop.ordering.application.shoppingcart;

import com.jung.algashop.ordering.application.shoppingcart.management.ShoppingCartItemInput;
import com.jung.algashop.ordering.application.shoppingcart.management.ShoppingCartManagementApplicationService;
import com.jung.algashop.ordering.domain.model.commons.Quantity;
import com.jung.algashop.ordering.domain.model.customer.*;
import com.jung.algashop.ordering.domain.model.product.*;
import com.jung.algashop.ordering.domain.model.shoppingcart.*;
import com.jung.algashop.ordering.infrastructure.listner.shoppingcart.ShoppingCartEventListener;
...
class ShoppingCartManagementApplicationServiceIT {
    ...
    void shouldCreateNewShoppingCartForExistingCustomer() {
        ...
        Optional<ShoppingCart> createdCart = shoppingCarts.ofId(new com.jung.algashop.ordering.domain.model.shoppingcart.ShoppingCartId(newShoppingCartId));
