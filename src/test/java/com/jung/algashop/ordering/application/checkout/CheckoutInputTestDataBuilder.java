...
import com.jung.algashop.ordering.domain.model.customer.CustomerTestDataBuilder; // Usado para referência de IDs padrão, se necessário

import java.util.UUID;

import static com.jung.algashop.ordering.domain.model.shoppingcart.ShoppingCartTestDataBuilder.DEFAULT_SHOPPING_CART_ID;
