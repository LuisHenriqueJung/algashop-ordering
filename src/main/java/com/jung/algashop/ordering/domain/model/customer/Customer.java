...
import com.jung.algashop.ordering.domain.model.AbstractEventSourceEntity;
import com.jung.algashop.ordering.domain.model.AggregateRoot;
import com.jung.algashop.ordering.domain.model.commons.*;
...
import static com.jung.algashop.ordering.domain.model.ErrorMessages.VALIDATION_ERROR_FULLNAME_IS_NULL;
...
public class Customer extends AbstractEventSourceEntity implements AggregateRoot<CustomerId> {
    ...
    private static Customer createBrandNew(FullName fullName, BirthDate birthDate, Email email,
        ...
        customer.publishDomainEvent(new CustomerRegisteredEvent(customer, customer.registeredAt()));
        return customer;
    }
